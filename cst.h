...
enum ParseTreeNodeType {
  ...
  CONST_VALUE_REAL, CONST_VALUE_CHAR, CONST_VALUE_STR, CONST_VALUE_BOOLEAN, TYPE_PART, TYPE_DECL_LIST, TYPE_DEFINITION, TYPE_DECL, SIMPLE_TYPE_DECL, 
  ...
  REPEAT_STMT, WHILE_STMT, FOR_STMT, DIRECTION, CASE_STMT, CASE_EXPR_LIST, CASE_EXPR, GOTO_STMT, EXPRESSION_LIST, EXPRESSION, EXPRESSION_GE, EXPRESSION_GT, EXPRESSION_LE, EXPRESSION_LT, EXPRESSION_EQ, EXPRESSION_NE,
